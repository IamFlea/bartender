...
class Civilization(object):
    ...
    icons = [3, 41, 46, 50, 45, 44, 36, 35, 43, 37, 39, 38, 42, 47, 106, 110, 108, 105, 117, 133, 93, 97, 99, 114, 190, 195, 197, 191, 231, 233, 230, 232, ]
    strings = ["Gaia", "British", "French", "Goths", "Teutons", "Japanese", "Chinese", "Byzantine", "Persians", "Saracens", "Turks", "Vikings", "Mongols", "Celts", "Spanish", "Aztecs", "Mayan", "Huns", "Koreans", "Italians", "Indians", "Incas", "Magyars", "Slavs", "Portuguese", "Ethopians", "Malians", "Berbers", "Khmer", "Malay", "Burmese", "Vietnamese"]
