...
class Civilization(object):
    ...
    strings = ["Gaia", "British", "French", "Goths", "Teutons", "Japanese", "Chinese", "Byzantine", "Persians", "Saracens", "Turks", "Mongols", "Celts", "Spanish", "Aztecs", "Mayan", "Huns", "Koreans", "Italians", "Indians", "Incas", "Magyars", "Slavs", "Portuguese", "Ethopians", "Malians", "Berbers", "Khmer", "Malay", "Burmese", "Vietnamese"]
