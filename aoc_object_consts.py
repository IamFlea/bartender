...
GROUPS = {0x400: "0", 0x200: "9", 0x100: "8", 0x080: "7", 0x040: "6", 0x020: "5", 0x010: "4", 0x008: "3", 0x004: "2",
          0x002: "1", }
...
class ClassData():
    all_str = ["Archer", "Artifact", "Trade Boat", "Building", "Civilian", "Ocean Fish", "Infantry", "Berry Bush",
               "Stone Mine", "Prey Animal", "Predator Animal", "Miscellaneous", "Cavalry", "Siege Weapon", "Terrain",
               "Tree", "Tree Stump", "Healer", "Monk", "Trade Cart", "Transport Boat", "Fishing Boat", "Warship",
               "Conquistador", "War Elephant", "Hero", "Elephant Archer", "Wall", "Phalanx", "Domestic Animal", "Flag",
               "Deep Sea Fish", "Gold Mine", "Shore Fish", "Cliff", "Petard", "Cavalry Archer", "Doppelganger", "Bird",
               "Gate", "Salvage Pile", "Resource Pile", "Relic", "Monk with Relic", "Hand Cannoneer",
               "Two Handed Swordsman", "Pikeman", "Scout", "Ore Mine", "Farm", "Spearman", "Packed Unit", "Tower",
               "Boarding Boat", "Unpacked Siege Unit", "Ballista", "Raider", "Cavalry Raider", "Livestock", "King",
               "Misc Building", "Controlled Animal", "Unknown"]
    military_str = ["Archer", "Infantry", "Prey Animal", "Predator Animal", "Cavalry", "Siege Weapon", "Healer", "Monk",
                    "Warship", "Conquistador", "War Elephant", "Hero", "Elephant Archer", "Phalanx", "Petard",
                    "Cavalry Archer", "Salvage Pile", "Resource Pile", "Monk with Relic", "Hand Cannoneer",
                    "Two Handed Swordsman", "Pikeman", "Scout", "Spearman", "Packed Unit", "Boarding Boat",
                    "Unpacked Siege Unit", "Ballista", "Raider", "Cavalry Raider"]
...
class IdData():
    ...
    # barracks
    swordsmen = UNITS['Militia'] + UNITS['Man-at-Arms'] + UNITS['Long Swordsman'] + UNITS['Two-Handed Swordsman'] + \
                UNITS['Champion']
    ...
    # def buildings
    arrow_tower = UNITS['Watch Tower'] + UNITS['Guard Tower'] + UNITS['Keep'] + UNITS['Fire Tower'] + UNITS[
        'The Accursed Tower'] + UNITS['Sea Tower'] + UNITS['The Tower of Flies']
    ...
    walls = UNITS['Palisade Wall'] + UNITS['Stone Wall'] + UNITS['Fortified Wall'] + UNITS['Sea Wall'] + UNITS[
        'Fortified Palisade Wall'] + UNITS['City Wall'] + UNITS['Fence'] + UNITS['Aqueduct']
